...
**[docs/deployment.md](docs/deployment.md)** — production setup: FastAPI on **Render**, Next.js on **Vercel**, env vars, and troubleshooting. The repo includes **`render.yaml`** for the API service (`rootDir: backend`).
...
- **`docs/tunnel.md`** — share a local demo over ngrok with one tunnel  
